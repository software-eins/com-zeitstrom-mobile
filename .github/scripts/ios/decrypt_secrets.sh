...
PROFILE_BLACK=2021-04-07-black.mobileprovision
...
gpg --quiet --batch --yes --decrypt --passphrase="$SECRETS_KEY" --output $SECRETS_PATH/$PROFILE_BLACK $SECRETS_PATH/$PROFILE_BLACK.gpg
...
cp $SECRETS_PATH/$PROFILE_BLACK ~/Library/MobileDevice/Provisioning\ Profiles/$PROFILE_BLACK
